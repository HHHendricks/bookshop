...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="images/products/${p.PRODUCT_FILENAME}"/>
                <div class="smallImg clearfix"><img src="images/products/${p.PRODUCT_FILENAME}"
                                                    data-src="images/products/${p.PRODUCT_FILENAME}"><img
            ...
            <div class="fr intro">
                ...
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ"><p class="fl"><img src="images/products/${p.PRODUCT_FILENAME}"
                                                                            alt="白瓷花瓶+20支快乐花"
                                                                            data-src="images/products/${p.PRODUCT_FILENAME}"></p>
                ...
                <div class="btns clearfix"><a href="javascript:shopAdd(${p.PRODUCT_ID},'z')"><p class="buy fl">立即购买</p></a><a href="javascript:shopAdd(${p.PRODUCT_ID},'s')"><p class="cart fr">
                    加入购物车</p></a></div>
            </div>
        </div>
    </div>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr" style="width:200px;"><h4>为你推荐</h4>
        ...
        <a href="selectproductview?id=${cl.PRODUCT_ID}">
            <dl>
                <dt><img src="images/products/${cl.PRODUCT_FILENAME}" height="220" width="180"></dt>
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                ...
                <c:forEach var="rl" items="${recentList}">
			        <a href="selectproductview?id=${rl.PRODUCT_ID}">
			            <dl>
			                <dt><img src="images/products/${rl.PRODUCT_FILENAME}" height="220" width="180"></dt>
			                <dd>${rl.PRODUCT_NAME}</dd>
			                <dd>￥${rl.PRODUCT_PRICE}.00</dd>
			            </dl>
			        </a>
		        </c:forEach>
