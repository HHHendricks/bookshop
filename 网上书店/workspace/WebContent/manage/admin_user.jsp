    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/bookshop/manage/admin_douserselect" method="get">
        ...
        <div class="result-wrap">
            <form action="/bookshop/manage/admin_douserdel" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="u" items="${userlist }">
	                        <tr>
	                            ...
	                            <td>
	                                ...
	                                <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.USER_NAME }】吗？','/bookshop/manage/admin_douserdel?id=${u.USER_ID }&cpage=${cpage }')">删除</a>
	                                </c:if>
                        ...
                        <script>
                        	...
                        	function delmore(mess,forname){
                        		if(confirm(mess)){
                        			var form=document.getElementById(forname);	//通过表单名获取整个表单
                        			form.submit();
                        		}
                        	}
                        </script>
                    ...
                    <div class="list-page"> 
                    	...
                    	<a href="admin_douserselect?cp=${tpgage}">尾页</a>
