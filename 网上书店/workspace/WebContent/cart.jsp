...
<div class="cart mt"><!-----------------logo------------------->
    ...
    <div class="table wrapper">
        ...
        <c:forEach var="c" items="${requestScope.shoplist}">
	        <div class="th">
	            <div class="pro clearfix"><label class="fl"><input name="ck" type="checkbox" value="${c.CART_ID }"/><span></span></label><a class="fl"
	                                                                                                        href="selectproductview?id=${c.CART_P_ID}">
	                <dl class="clearfix">
	                    <dt class="fl"><img width="120" height="120" src="images/products/${c.CART_P_FILENAME}"></dt>
	            ...
	            <div class="number"><p class="num clearfix"><img class="fl sub" src="img/temp/sub.jpg"><span
	                   datasrc="${c.CART_ID}" class="fl">${c.CART_QUANTITY}</span><img class="fl add" src="img/temp/add.jpg"></p></div>
        ...
        <div class="tr clearfix"><label class="fl"><input class="checkAll" type="checkbox"/><span></span></label>
            <p class="fl"><a href="#">全选</a><a href="#" class="del">清空</a></p>
...
<script>
	function toorder()
	{
		...
		location.href = "orderconfirm?ids="+str;
	}
</script>
<div class="mask"></div>
